...
def chart_jeongja():
    ...
    labels = []
    values = []
    read_data(7, 30, 'static/data/jeongja2/1026_jeongja2.txt', labels, values, 14400)

    labels2 = []
    values2 = []
    read_data(7, 30, 'static/data/jeongja2/1027_jeongja1.txt', labels2, values2, 14400)

    labels3 = []
    values3 = []
    read_data(7, 30, 'static/data/jeongja2/1028_jeongja2.txt', labels3, values3, 14400)

    labels4 = []
    values4 = []
    read_data(7, 30, 'static/data/jeongja2/1029_jeongja2.txt', labels4, values4, 14400)

    labels5 = []
    values5 = []
    read_data(7, 30, 'static/data/jeongja2/1030_jeongja2.txt', labels5, values5, 14400)

    labels6 = []
    values6 = []
    read_data(7, 30, 'static/data/jeongja2/1031_jeongja2.txt', labels6, values6, 14400)

    labels7 = []
    values7 = []
    read_data(7, 30, 'static/data/jeongja2/1101_jeongja2.txt', labels7, values7, 14400)
...
def chart_cheonmak():
    ...
    labels = []
    values = []
    read_data(7, 30, 'static/data/cheonmak2/1026_cheonmak2.txt', labels, values, 14400)

    labels2 = []
    values2 = []
    read_data(7, 30, 'static/data/cheonmak2/1027_cheonmak2.txt', labels2, values2, 14400)

    labels3 = []
    values3 = []
    read_data(7, 30, 'static/data/cheonmak2/1028_cheonmak2.txt', labels3, values3, 14400)

    labels4 = []
    values4 = []
    read_data(7, 30, 'static/data/cheonmak2/1029_cheonmak2.txt', labels4, values4, 14400)

    labels5 = []
    values5 = []
    read_data(7, 30, 'static/data/cheonmak2/1030_cheonmak2.txt', labels5, values5, 14400)

    labels6 = []
    values6 = []
    read_data(7, 30, 'static/data/cheonmak2/1031_cheonmak2.txt', labels6, values6, 14400)

    labels7 = []
    values7 = []
    read_data(7, 30, 'static/data/cheonmak2/1101_cheonmak2.txt', labels7, values7, 14400)
...
def statistics():
    ...
    return render_template('statistics.html', jisun2_avg_1026=jisun2_avg_1026, jeongja2_avg_1026=jeongja2_avg_1026, cheonmak2_avg_1026=cheonmak2_avg_1026, jisun2_avg_1027=jisun2_avg_1027, jeongja2_avg_1027=jeongja2_avg_1027, cheonmak2_avg_1027=cheonmak2_avg_1027, jisun2_avg_1028=jisun2_avg_1028, jeongja2_avg_1028=jeongja2_avg_1028, cheonmak2_avg_1028=cheonmak2_avg_1028, jisun2_avg_1029=jisun2_avg_1029, jeongja2_avg_1029=jeongja2_avg_1029, cheonmak2_avg_1029=cheonmak2_avg_1029, jisun2_avg_1030=jisun2_avg_1030, jeongja2_avg_1030=jeongja2_avg_1030, cheonmak2_avg_1030=cheonmak2_avg_1030, jisun2_avg_1031=jisun2_avg_1031, jeongja2_avg_1031=jeongja2_avg_1031, cheonmak2_avg_1031=cheonmak2_avg_1031, jisun2_avg_1101=jisun2_avg_1101, jeongja2_avg_1101=jeongja2_avg_1101, cheonmak2_avg_1101=cheonmak2_avg_1101, jisun2_max=jisun2_max, jeongja2_max=jeongja2_max, cheonmak2_max=cheonmak2_max)
